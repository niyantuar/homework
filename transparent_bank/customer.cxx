...
Customer::Customer()
    : _minimum_balance_allowed{_DEFAULT_MINIMUM_BALANCE_ALLOWED}
    , _maximum_balance_allowed{_DEFAULT_MAXIMUM_BALANCE_ALLOWED}
    , _balance{}
    , _is_frozen{false} {}
...
void Customer::unfreeze() noexcept {
    _is_frozen = false;
}
void Customer::freeze() noexcept {
    _is_frozen = true;
}
